!(function(t) {
  ...
  function(t, e, i) {
    ...
    function R(t) {
      var e = {};
      for (var i in V) e[i] = t && L(t, i) ? t[i] : V[i];
      if (
          ...
          if (this.regexp_eatFixedHexDigits(t, 4)) {
            ...
            if (t.switchU && n >= 55296 && n <= 56319) {
              ...
              if (
                ...
                if (s >= 56320 && s <= 57343)
                  return (
                    (t.lastIntValue = 1024 * (n - 55296) + (s - 56320) + 65536),
                    !0
                  );
              }
              (t.pos = r), (t.lastIntValue = n);
            }
            return !0;
          }
          if (
        ...
        for (var e = '', i = ++this.pos; ; ) {
          ...
          92 === n
            ? ((e += this.input.slice(i, this.pos)),
              ...
              (i = this.pos))
            : (k(n) && this.raise(this.start, 'Unterminated string constant'),
              ++this.pos);
        }
        return (
      ...
      a = function(o, h) {
        ...
        var _ = new function() {
          ...
          z = l.extend({
              ...
              l > 0 &&
                (null == t || 'object' == typeof t
                  ...
                  : ((a = [t, e]),
                    ...
                    (u = r !== h ? [r, s] : null))),
                new V(a, this, '_point'),
                new V(o, this, '_handleIn'),
                new V(u, this, '_handleOut'),
            ...
            reversed: function() {
              return new z(this._point, this._handleOut, this._handleIn);
            },
            remove: function() {
              return !!this._path && !!this._path.removeSegment(this._index);
            },
            clone: function() {
              return new z(this._point, this._handleIn, this._handleOut);
            },
            equals: function(t) {
              return (
                t === this ||
              ...
              initialize: function(t, e, i, n, r, s, a, o) {
                ...
                3 === p
                  ...
                  : p
                    ? 1 === p
                      ? 'segment1' in t
                        ? ((h = new z(t.segment1)), (u = new z(t.segment2)))
                        : 'point1' in t
                          ? ((c = t.point1),
                            (f = t.handle1),
                            (d = t.handle2),
                      ...
                      : 2 === p
                        ...
                        : 4 === p
                          ...
                          : 8 === p &&
                            ...
                            (d = [r - a, s - o]))
                    : ((h = new z()), (u = new z())),
                  (this._segment1 = h || new z(c, null, f)),
                  (this._segment2 = u || new z(l, d, null));
              },
              _serialize: function(t, e) {
                return l.serialize(
                  this.hasHandles()
                          ...
                          : function i(n, r, s, a, o, h, u, c, l, f, d, p, g) {
                              ...
                              if (
                                (0 === C &&
                                  ...
                                  0 === M) ||
                                null == (_ = e(O, z, P, I)) ||
                                null == (v = e(O.reverse(), z.reverse(), P, I))
                              )
                                return l;
                              var V = f + (d - f) * _,
                                B = f + (d - f) * v;
                              if (Math.max(g - p, B - V) < 1e-9) {
                                var D = (V + B) / 2,
                                  F = (p + g) / 2;
                                t(
                                  o,
                                ...
                                l =
                                  g - p >= 1e-9
                                    ? i(r, n, a, s, o, h, !u, c, l, p, g, V, B)
                                    : i(n, r, s, a, o, h, u, c, l, V, B, p, g);
                              return l;
                            })(
                        y ? r : i,
                        y ? i : r,
          ...
          D = P.extend({
            ...
            interpolate: function(t, e, i) {
              ...
              var h = o.length,
                u = a.length;
              if (h < u)
                for (var c = n ? z : F, l = h; l < u; l++) this.add(new c());
            ...
            },
            {
              ...
              add: function(t) {
                return arguments.length > 1 && 'number' != typeof t
                  ? this._add(z.readList(arguments))
                  : this._add([z.read(arguments)])[0];
              },
              insert: function(t, e) {
                return arguments.length > 2 && 'number' != typeof e
                  ? this._add(z.readList(arguments, 1), t)
                  : this._add([z.read(arguments, 1)], t)[0];
              },
              addSegment: function() {
                return this._add([z.read(arguments)])[0];
              },
              insertSegment: function(t) {
                return this._add([z.read(arguments, 1)], t)[0];
              },
              addSegments: function(t) {
                return this._add(z.readList(t));
              },
              insertSegments: function(t, e) {
                return this._add(z.readList(e), t);
              },
              ...
              flatten: function(t) {
                for (
                  ...
                  n.push(new z(e[r].curve.slice(0, 2)));
                !this._closed &&
                  i > 0 &&
                  n.push(new z(e[i - 1].curve.slice(6))),
                  this.setSegments(n);
              },
              simplify: function(t) {
                ...
                if (/^(?:asymmetric|continuous)$/.test(n)) {
                  ...
                  for (w = 1; w < _; w++) {
                    var M = w < A,
                      ...
                      V = (M ? 1 : d ? 1 : 2) / k;
                    (k = E[w] = N - V),
                      (C = P[w] = O * x[w]._x + z * x[w + 1]._x - V * C),
                      (S = I[w] = O * x[w]._y + z * x[w + 1]._y - V * S);
                  }
              ...
              toShape: function(t) {
                ...
                function l(t) {
                  ...
                  if (n.isOrthogonal(r)) {
                    var s = e._point,
                      a = i._point,
                      o = new k(s, n, !0).intersect(new k(a, r, !0), !0);
                    return (
                      o &&
                      _.isZero(
                        n.getLength() / o.subtract(s).getLength() -
                          0.5522847498307936
                      ) &&
                      _.isZero(
                ...
                if (
                  ...
                  a._handleOut.isZero() &&
                    ...
                    s._point
                      .subtract(a._point)
                      .isOrthogonal(o._point.subtract(s._point)))
                    ? ((e = T.Rectangle),
                      (i = new x(f(0, 3), f(0, 1))),
                      (r = u[1]._point.add(u[2]._point).divide(2)))
                    : 8 === u.length &&
                      l(0) &&
                      l(2) &&
                      l(4) &&
                      ...
                      c(3, 7)
                      ? ((e = T.Rectangle),
                        (n = (i = new x(f(1, 6), f(0, 3)))
                          .subtract(new x(f(0, 7), f(1, 2)))
                          .divide(2)),
                        (r = u[3]._point.add(u[4]._point).divide(2)))
                      : 4 === u.length &&
                        l(0) &&
                        l(1) &&
                        l(2) &&
                        l(3) &&
                        (_.isZero(f(0, 2) - f(1, 3))
                          ? ((e = T.Circle), (n = f(0, 2) / 2))
                          : ((e = T.Ellipse),
                            (n = new x(f(2, 0) / 2, f(3, 1) / 2))),
                        (r = u[1]._point)),
                  e)
                ) {
                  var d = this.getPosition(!0),
                    p = new e({ center: d, size: i, radius: n, insert: !1 });
                  return (
                    p.copyAttributes(this, !0),
                    p._matrix.prepend(this._matrix),
                    p.rotate(r.subtract(d).getAngle() + 90),
                    (t === h || t) && p.insertAbove(this),
                    p
                  );
                }
                return null;
              ...
              return {
                moveTo: function() {
                  ...
                  1 === t.length && this.removeSegment(0),
                    t.length || this._add([new z(m.read(arguments))]);
                },
                moveBy: function() {
                  throw new Error('moveBy() is unsupported on Path items.');
                },
                lineTo: function() {
                  this._add([new z(m.read(arguments))]);
                },
                cubicCurveTo: function() {
                  ...
                  r.setHandleOut(e.subtract(r._point)),
                    this._add([new z(n, i.subtract(n))]);
                },
          ...
          statics: new function() {
            ...
            return {
              Line: function() {
                return i(
                  [
                    new z(m.readNamed(arguments, 'from')),
                    new z(m.readNamed(arguments, 'to')),
                  ],
                  !1,
                  arguments
                );
              ...
              Rectangle: function() {
                ...
                if (!r || r.isZero())
                  e = [new z(s), new z(a), new z(o), new z(h)];
                else {
                  var u = (r = x.min(r, n.getSize(!0).divide(2))).width,
                    ...
                    f = c * t;
                  e = [
                    new z(s.add(u, 0), null, [-l, 0]),
                    new z(s.subtract(0, c), [0, f]),
                    new z(a.add(0, c), null, [0, -f]),
                    new z(a.add(u, 0), [-l, 0], null),
                    new z(o.subtract(u, 0), null, [l, 0]),
                    new z(o.add(0, c), [0, -f], null),
                    new z(h.subtract(0, c), null, [0, f]),
                    new z(h.subtract(u, 0), [l, 0]),
                  ];
                }
              ...
              RegularPolygon: function() {
                for (
                  ...
                  h[u] = new z(t.add(a.rotate((u + o) * r)));
              ...
              Star: function() {
                for (
                  ...
                  o[h] = new z(t.add(a.rotate(s * h).multiply(h % 2 ? r : n)));
            ...
            function p(n, r, s, a, o) {
              ...
              for (var E = 0, T = r.length; E < T; E++) {
                ...
                if (
                  ...
                  h = O;
                  for (var z = N.getLastCurve(); z && z !== M; ) {
                    var V = z.getValues();
                    if (V[l] !== V[l + 6]) {
                      h = V;
                      break;
            ...
            function v(t, e) {
              ...
              for (var h = 0, u = t.length; h < u; h++) {
                ...
                for (; p; ) {
                  ...
                  var I = d.getNext();
                  g.add(new z(d._point, f, I && d._handleOut)),
                    (d._visited = !0),
                    l.push(d),
          ...
          U = l.extend({
            ...
            addCurve: function(t, e) {
              t[t.length - 1].setHandleOut(e[1].subtract(e[0])),
                t.push(new z(e[3], e[2].subtract(e[3])));
            },
          ...
          (l.exports.PaperScript = function() {
            ...
            g ||
              ...
              (f = function(t) {
                ...
                function Ne() {
                  return f === A || f === I ? Me() : Ve(!0);
                }
                function Oe(t, e) {
                  f === E ? (t.id = Ve()) : e ? me() : (t.id = null),
                    (t.params = []);
                  var i = !0;
                  for (ve(ot); !pe(ht); )
                    i ? (i = !1) : ve(ut), t.params.push(Ve());
                  var n = x,
                    r = w;
                  if (
                    ((x = !0),
              ...
              'object' == typeof t && 'object' == typeof e
                ? f(t)
                : ((n = [t]),
                  (s = 'function' == typeof (r = f) ? r.apply(t, n) : r) ===
                    h || (e.exports = s)),
              g.version || (g = null));
            function _(t, e) {
              return (p.acorn || g).parse(t, e);
            }
            var v = {
                '+': '__add',
                '-': '__subtract',
                  ...
                  if (i) {
                    ...
                    switch (i.type) {
                      case 'UnaryExpression':
                        if (i.operator in y && 'Literal' !== i.argument.type) {
                          var l = r(i.argument);
                          s(i, '$__("' + i.operator + '", ' + l + ')');
                        }
                        break;
                      case 'BinaryExpression':
                        if (i.operator in v && 'Literal' !== i.left.type) {
                          var f = r(i.left),
                            d = r(i.right),
                            p = (function(e, i) {
            ...
            function k(t, e, i) {
              ...
              (t = d.code),
                p({ __$__: b, $__: C, paper: e, view: r, tool: s }, !0),
                p(e),
                (h = l
                  .each(
                    h,
            ...
            function P() {
              l.each(c && c.getElementsByTagName('script'), A);
            }
            return (
              m.inject(w),
              x.inject(w),
    ...
    window,
      ...
      (function(t) {
        ...
        function(t, e, i) {
          ...
          e.hitsFilter = function(t) {
            var e = [];
            return (
              t.forEach(function(t) {
                (h = c.scope.hitTest(t.point)), h && e.push(t);
              }),
              e
            );
          };
          ...
          Object.defineProperty(e, '__esModule', { value: !0 }),
            (e.default = function(t) {
              ...
              var i,
                ...
                o = new e.Tool(),
                h = r.settings.alpha,
                u = r.settings.lightness,
                c = r.settings.hue,
                l = r.settings.saturation,
                f = r.settings.strokeColor,
              ...
              return (
                (o.onMouseDown = function(t) {
                  a = null;
                  var n = e.project.hitTest(t.point, d);
                  if (n) {
                    if (t.modifiers.shift)
                      return void ('segment' == n.type && n.segment.remove());
                    n && (a = n.item),
                      'fill' == n.type &&
                        e.project.activeLayer.addChild(n.item);
                  } else
                    i &&
                      ((i.selected = !1),
                      e.project.activeLayer.removeChildren()),
                      (s = t.point),
                      p((i = new e.Path.Circle({ center: s, radius: 0 }))),
                      (i.fullySelected = !0);
                }),
                (o.onMouseMove = function(t) {
                  (e.project.activeLayer.selected = !1),
                ...
                (o.onMouseDrag = function(t) {
                  if (a)
                    ...
                    var n = t.point.getDistance(s);
                    e.project.activeLayer.removeChildren(),
                      p((i = new e.Path.Circle({ center: s, radius: n })));
                  }
                }),
              ...
              return (
                (o.onMouseDown = function(t) {
                  ...
                  if (n) {
                    ...
                    var r = new e.Size(0, 0),
                      o = new e.Rectangle({ point: s, size: r });
                    p((i = new e.Path(o))), (i.fullySelected = !0);
                  }
                }),
                (o.onMouseMove = function(t) {
                  (e.project.activeLayer.selected = !1),
                ...
                (o.onMouseDrag = function(t) {
                  if (a)
                    ...
                    new e.Point(t.x, t.y);
                    var n = new e.Rectangle({ from: s, to: t.point });
                    e.project.activeLayer.removeChildren(),
                      p((i = new e.Path.Rectangle(n)));
                  }
                }),
                (o.onMouseUp = function(t) {
                  i.fullySelected = !0;
            ...
            (e.default = function(t) {
              ...
              return (
                (o.onMouseDown = function(t) {
                  a = s = null;
                  var n,
                    r = e.project.hitTest(t.point, d);
                  if (r) {
                    if (t.modifiers.shift)
                      return void ('segment' == r.type && r.segment.remove());
                    if (r)
                      if (((s = r.item), 'segment' == r.type)) a = r.segment;
                      else if ('stroke' == r.type) {
                        var o = r.location;
                        (a = s.insert(o.index + 1, t.point)), s.smooth();
                      }
                    'fill' == r.type && e.project.activeLayer.addChild(r.item);
                  } else
                    i &&
                      ((i.selected = !1),
                      e.project.activeLayer.removeChildren()),
  ...
  function(t, e, i) {
    ...
    var r = document.getElementById('core');
    window.onload = function() {
      (r.style.height = '100%'),
        (r.style.width = '100vw'),
        (r.height = document.body.height),
        (r.width = document.body.width),
        n.circle(r);
    };
  },
]);
